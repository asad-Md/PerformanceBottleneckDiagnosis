...
SESSIONS=(
  "cpu_extreme|--cpu 64"
  "cpu_ultra|--cpu 128"
  "mem_extreme|--vm 8 --vm-bytes 80%"
  "mem_thrashing|--vm 16 --vm-bytes 90% --vm-keep"
  "cpu_mem_extreme|--cpu 64 --vm 8 --vm-bytes 80%"
  "cpu_mem_ultra|--cpu 128 --vm 16 --vm-bytes 90%"
  "io_extreme|--io 8"
  "cpu_io_extreme|--cpu 64 --io 8"
  "lock_extreme|--mutex 32 --futex 32"
  "lock_cpu_mix|--cpu 32 --mutex 32 --futex 16"
  "everything_max|--cpu 64 --vm 8 --vm-bytes 70% --io 4 --mutex 16"
  "everything_insane|--cpu 128 --vm 16 --vm-bytes 80% --io 8 --mutex 32"
)
