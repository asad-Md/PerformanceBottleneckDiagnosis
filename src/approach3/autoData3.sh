...
SESSIONS=(
  ...
  "cpu_4x|--cpu 64"
  "cpu_8x|--cpu 128"
  "mem_reclaim|--vm 8 --vm-bytes 85% --vm-keep"
  "mem_heavy_reclaim|--vm 16 --vm-bytes 90% --vm-keep"
  "cpu_mem_2x|--cpu 32 --vm 8 --vm-bytes 80% --vm-keep"
  "cpu_mem_4x|--cpu 64 --vm 16 --vm-bytes 85% --vm-keep"
  "cpu_mem_8x|--cpu 128 --vm 16 --vm-bytes 90% --vm-keep"
  "cpu_mem_io|--cpu 64 --vm 8 --vm-bytes 80% --io 4"
  "cpu_mem_io_heavy|--cpu 128 --vm 16 --vm-bytes 85% --io 8"
  "lock_heavy|--mutex 64 --futex 32"
  "lock_cpu_heavy|--cpu 64 --mutex 64 --futex 32"
  "everything_extreme|--cpu 64 --vm 8 --vm-bytes 80% --io 4 --mutex 32"
  "everything_max|--cpu 128 --vm 16 --vm-bytes 85% --io 8 --mutex 64"
  "everything_insane|--cpu 128 --vm 16 --vm-bytes 90% --io 8 --mutex 64 --vm-keep"
)
